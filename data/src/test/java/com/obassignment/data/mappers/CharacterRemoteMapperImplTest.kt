...
class CharacterRemoteMapperImplTest {
    ...
    fun `convert characterListDTO to List of ResultModel`() {
        val urlDTO = UrlDTO(
            "detail",
            "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=fcf9a89dd88a8f74de6a92ffa8deccc6"
        )
        ...
        val itemXXXDTO =
            ItemXXXDTO("", "http://gateway.marvel.com/v1/public/characters/1011334", "")
        ...
        val thumbnailDTO =
            ThumbnailDTO("jpg", "http://i.annihil.us/u/prod/marvel/i/mg/c/e0/535fecbbb9784")
        ...
        Mockito.`when`(characterRemoteMapperImpl.toModel(characterListDTO))
